...
TIC80_SRC = src/tic80.c src/tic.c $(BLIP_SRC) src/jsapi.c src/bfapi.c src/luaapi.c $(DUKTAPE_LIB)/duktape.c
TIC80_O = bin/tic80.o bin/tic.o bin/tools.o bin/blip_buf.o bin/jsapi.o bin/bfapi.o bin/luaapi.o bin/duktape.o bin/gif.o
